...
function updateDisplay() {
  ...
  // Always render current load if not finished
  if (true) // force load block to always render {
    const block = document.createElement("div");
    block.className = "load-block";
...
function clearJob() {
  if (confirm("❌ This will permanently delete the job and reset all data. Continue?")) {
